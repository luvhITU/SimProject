...
public class Config {
    ...
    public static class Wolf {
        public static final Set<String> DIET = Set.of("Rabbit", "Fox", "Bear", "Wolf", "Carcass");
    ...
    public static class Bear {
        public static final Set<String> DIET = Set.of("BerryBush", "Rabbit", "Fox", "Wolf", "Bear", "Carcass");

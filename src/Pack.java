...
public class Pack implements Actor {
...
// Tankar:
// Um troyttir ella graður, far midlertidligt úr pack og sov ella mogga
// Aftana hvørt step, um mode = attack, random move, ella eat og man ikki er í pack, gang so ímóti einum pack member
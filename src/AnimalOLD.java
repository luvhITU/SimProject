...
//
//public abstract class AnimalOLD extends Edible implements Actor, DynamicDisplayInformationProvider {
//
//
...
//
//    public AnimalOLD(Set<String> diet, int nutrition, int damage, double absorptionPercentage) {
//        super(nutrition);
//        this.diet = diet;
...
//    }
//
//    public int calcDamageTaken(AnimalOLD attacker) {
...
//                AnimalOLD partner = (AnimalOLD) entity;
